...
export const cOrgFaqs: Copy[] = [
  ...
  },
  {
    ...
    content:
      "Just take your next dose as scheduled!",
  },
  {
    title:
      "What happens if I’m late taking a dose?",
    content:
...
export const pilotFaqs: Copy[] = [
  ...
  },
  {
    ...
    content:
      (
        <>
          Recommended CBD and Delta-9 THC products can be ordered through your care
          plan for home delivery. They are delivered just like any other package you
          might receive from the USPS or others.
          <br />
          <br />
          At times, we may recommend products to be picked-up from a dispensary near you.
          For these products, you’ll simply select a time to pick them up in your care plan
          and our team will then order the products for you. You just show up at the dispensary
          at the time you chose, pick-up your products and pay for them.
        </>
      ),
  },
  {
  ...
  },
  {
    ...
    title: "Do I need a medical card to use EO?",
    content:
      "No. You can use EO without a medical card/cannabis certification. We’ll ask you about your medical card status when you’re sharing your profile information.",
  },
  {
    title:
...
export const faqs: Copy[] = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <br />
        At times, we may recommend products to be picked-up from a dispensary
        near you. For these products, you’ll simply select a time to pick
        them up in your care plan and our team will then order the products
        for you. You just show up at the dispensary at the time you chose,
        pick-up your products and pay for them.
      </>
    ),
  },
  {
  ...
  {
    title:
      "Do I need a medical card to use EO?",
    content:
      "No. You can use EO without a medical card. We’ll ask you about your medical card status when you’re sharing your profile information.",
  },
  {
  ...
  {
    title:
      "What happens if I miss an opportunity to provide feedback?",
    content:
      "Needless to say, the more feedback you provide, the better we can care for you. However, we know sometimes schedules change and life happens. If you can’t provide feedback when prompted, don’t worry. Just keep going as guided.",
  },
  {
  ...
  {
    title: "Can I use a different dispensary or delivery provider than the one you’ve recommended?",
    content: "The answer is an honest “maybe”. If you’d like to make a change just email us at support@eo.care or call 888-823-6143. We’ll do everything we can to accommodate your request.",
  },
  {
    title: "What happens if I run out of a particular product?",
    content:
