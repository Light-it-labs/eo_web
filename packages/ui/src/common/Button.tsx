...
export const Button = forwardRef(
  (
    ...
    <button
      ...
      type={type}
      className={tw(
        "flex gap-2 items-center rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-0",
        variant === "primary" &&
          "bg-primary text-white hover:bg-primary-800 focus:bg-primary focus:ring-primary-100",
        variant === "outline" &&
        ...
        variant === "tertiary-link" &&
          "text-primary hover:text-primary-700 focus:text-primary-700 focus:ring-primary-700 focus:ring-1",
        ...
        disabled && [
          variant === "primary" && "bg-primary-dark-50 text-primary-white-600",
          variant === "outline" &&
